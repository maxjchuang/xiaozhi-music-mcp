...
if [[ "${skip_tests}" == "false" ]]; then
    ...
    "${VENV_PYTHON}" -m unittest -v \
        test_music_providers.py test_music_cache.py test_audio_proxy.py test_music_mcp_server.py \
        test_provider_manager.py test_netease_account.py test_music_search.py test_web_search.py test_usage_analytics.py test_analytics_manager.py \
